...
// ---------- Convenience lookups ----------
export const PLAN_LABELS = Object.fromEntries(Object.values(PLANS).map((p) => [p.code, p.label]));
export const PLAN_PRICES_KES = Object.fromEntries(Object.values(PLANS).map((p) => [p.code, p.amount]));
export const PLAN_LIMITS = Object.fromEntries(Object.values(PLANS).map((p) => [
    p.code,
